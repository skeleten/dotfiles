...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-dialog" '("slack-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slack-room-info-buffer" '("slack-")))
