...
(eieio-defclass-autoload 'jsonrpc-connection 'nil "jsonrpc" :documentation)

(eieio-defclass-autoload 'jsonrpc-process-connection '(jsonrpc-connection) "jsonrpc" :documentation)
