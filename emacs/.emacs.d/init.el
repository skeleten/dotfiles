...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (all-the-icons-gnus all-the-icons-dired helm powerline moe-theme dashboard paredit origami web-mode which-key offlineimap ace-jump-mode company-restclient restclient lsp-rust flycheck-rust company-lsp auctex zencoding-mode yaml-mode window-number toml-mode smartparens rainbow-mode rainbow-delimiters racer powershell neotree multiple-cursors monokai-theme mediawiki markdown-mode magit ivy ht flycheck flatland-theme fish-mode expand-region doom-themes company ace-popup-menu)))
